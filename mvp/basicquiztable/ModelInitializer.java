...
public final class ModelInitializer
{
    ...
    /**
     * Die Methode erzeugt das Modell und fügt alle Fragen, falls sie aus der Datei ausgelesen werden können, zum Modell
     * hinzu.
     * 
     * @param pathName
     ...
     * @throws IOException
     *             wird geworfen, wenn aus irgendeinem Grund das Einlesen der Datei nicht funktioniert. Hierzu gehört
     *             u.a die {@link FileNotFoundException}.
     * @throws NumberFormatException
     *             wird geworfen, wenn eine Dateizeile nicht interpretiert werden kann, weil der Index für die korrekte
     *             Antwort nicht eingelesen werden konnte.
     * @throws IndexOutOfBoundsException
     *             wird geworfen, wenn eine Dateizeile nicht interpretiert werden kann, weil mind. eine der geschweiften
     *             Klammern nicht oder an falscher Position gefunden wird.
     * @throws IllegalArgumentException
     *             wird beim Erzeugen einer <code>Question</code> geworfen, wenn deren Argumente ungültig sind.
     */
    ...
    private static void checkIndices(int indexAnswerStart, int indexAnswerEnds) 
    {
        ...
        {
            throw new IndexOutOfBoundsException("Es konnte kein (oder nur an erster Stelle) Symbol \"" + ANSWER_STARTS_SYMBOL
                    + "\" zur Kennzeichnung des Antwortenbeginns gefunden werden. "
                    + "Demzufolge können weder Frage noch Antwortmöglichkeiten klar voneinander abgegrenzt werden.");
        }
        if (indexAnswerEnds < 0 || indexAnswerEnds <= indexAnswerStart) 
        {
            throw new IndexOutOfBoundsException("Es konnte kein Symbol \"" + ANSWER_ENDS_SYMBOL
                    + "\" zur Kennzeichnung des Endes der Antwortmöglichkeiten hinter den Antworten gefunden werden.");
        }
    }
